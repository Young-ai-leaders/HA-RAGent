...
class RAGentListPlannedActionsTool(llm.Tool):
    ...
    description = "List all currently scheduled one-time Home Assistant actions."
    ...
    def __init__(self, hass: HomeAssistant, subentry_id: str, language: str | None = None) -> None:
        ...
        if language == "de":
            self.description = "Liste alle derzeit geplanten einmaligen Home-Assistant-Aktionen auf."
